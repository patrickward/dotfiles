...
hi Cursor ctermfg=233 ctermbg=15 cterm=NONE guifg=#131313 guibg=#ffffff gui=NONE
...
hi IncSearch ctermfg=233 ctermbg=77 cterm=NONE guifg=#131313 guibg=#66cc33 gui=NONE
...
hi DiffAdd ctermfg=15 ctermbg=64 cterm=bold guifg=#ffffff guibg=#427f09 gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#870404 guibg=NONE gui=NONE
hi DiffChange ctermfg=15 ctermbg=17 cterm=NONE guifg=#ffffff guibg=#1a2f4d gui=NONE
